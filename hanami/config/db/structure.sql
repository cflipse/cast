...
CREATE TABLE `podcasts`(
  ...
  `uuid` varchar(255) DEFAULT(NULL) NULL,
...
CREATE TABLE `profiles`(
  `id` INTEGER DEFAULT(NULL) NOT NULL PRIMARY KEY AUTOINCREMENT,
  `uuid` varchar(255) DEFAULT(NULL) NOT NULL,
...
CREATE UNIQUE INDEX `index_profiles_on_uuid` ON `profiles`(`uuid`);
...
CREATE TABLE `episodes`(
  ...
  `description` TEXT DEFAULT(NULL) NULL,
  `podcast_id` INTEGER DEFAULT(NULL) NOT NULL,
...
CREATE UNIQUE INDEX `index_episodes_on_uuid` ON `episodes`(`uuid`);
...
CREATE TABLE `podcast_hosts`(
  `id` INTEGER DEFAULT(NULL) NOT NULL PRIMARY KEY AUTOINCREMENT,
  `uuid` varchar(255) DEFAULT(NULL) NULL,
  `profile_id` INTEGER DEFAULT(NULL) NOT NULL,
  `podcast_id` INTEGER DEFAULT(NULL) NOT NULL,
